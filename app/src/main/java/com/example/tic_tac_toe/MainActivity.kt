...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val plyr1 = findViewById<EditText>(R.id.plyr1)
        val plyr2 = findViewById<EditText>(R.id.plyr2)


        startGameButton.setOnClickListener {

            // If the text entered in any of the edit texts spaces is empty the game will not start
            if(plyr1.text.toString().isEmpty() or plyr2.text.toString().isEmpty()){
                ...
                newIntent.putExtra("Player1",plyr1.text.toString())
                newIntent.putExtra("Player2", plyr2.text.toString())
